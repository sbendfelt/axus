...
Type.v310KeyFunction = function(typeName) {
  return Type.keyFunction(typeName, '310');
};

Type.keyFunction = function(typeName, apiVersion) {
  return `${apiVersion}__${typeName}`;
};
