...
const SessionProvider = require('./session-provider.js');
...
class Providers {
    ...
    constructor(bridge) {
        ...
        this.objectFactoryProvider = new ObjectFactoryProvider(bridge);
        ...
        this.sessionProvider = new SessionProvider(bridge);
    }
    ...
    /**
     * getSessionProvider - returns the SessionProvider
     *
     * @return {type}  description
     */
    getSessionProvider() {
